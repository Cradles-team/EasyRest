    ...
    return (
        <div className={main.content}>
            <div className={main.pic}>
                <div className={main.text}>EasyRest System - розумна система для відстеження черг у закладах харчування.</div>
            </div>
            <div className={main.forAndroid}><img src={Pixel}/></div>
            <div className={main.forIOS}><img src={Iphone}/></div>
            <div className={main.appDescription}>Мобільний додаток допоможе тобі знайти вільний столик у ресторані <br/> і не витрачати час у черзі.
                Також ти можеш переглянути меню та ціни, <br/> забронювати столик або прокласти маршрут до потрібного тобі закладу.
                <Navigation/>
            </div>
        </div>
    )
