...
function Product() {
    return (
        <div className={product.content}>
            ...
            <p className={product.text}>EasyRest System - розумна система, яка за допомогою датчиків під столами <br/> зчитує чи сидить хтось за столом та відображає цю інформацію<br/> на екрані смартофна або комп'ютера.
